...
Before installation, read [host preflight](host-preflight.md), including the Windows 10 screenshot-based Computer Use substitute and private-repository access recovery.
